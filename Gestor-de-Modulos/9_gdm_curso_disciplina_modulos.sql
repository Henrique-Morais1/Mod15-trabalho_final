...
CREATE TABLE curso_disciplina_modulos (
    ...
    horas_lecionadas DECIMAL(5.2) UNSIGNED NOT NULL,
    PRIMARY KEY (id),
    CONSTRAINT fk_curso_disciplinamodulos
...
INSERT INTO curso_disciplina_modulos (id_curso, nome, n_ordem, n_hora, ano_lecionacao) VALUES
(1, 'Módulo1', 1, 34.00, 1),
(1, 'Módulo2', 2, 34.00, 1),
(1, 'Módulo3', 3, 32.00, 1),
(1, 'Módulo4', 4, 36.00, 2),
